...
{
    'name': 'Helpdesk Support Ticket by Helpdesk Team',
    'depends': [
    ...
    'summary': """This app allow your customer to view all your teams in website and allow them to create ticket.""",
    'description': """
Support Ticket Team
...
issue manager
    ...
    # 'live_test_url': 'https://youtu.be/X-C8Q95hIGA',
    # 'live_test_url': 'https://youtu.be/wctimT7ibLE',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/support_ticket_by_team/111',#'https://youtu.be/EhWAs1vVqOo',
    'version': '4.6.1',
    ...
    'data':[
        ...
        'views/helpdesk_support_team_template.xml',
    ],
    'installable' : True,
    'application' : False,
}
