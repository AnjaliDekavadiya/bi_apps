...
{
    'name': 'Reassign/Escalate Helpdesk Support Ticket Team and Responsible',
    'version': '6.5',
    'price': 29.0,
    'depends': [
    ...
    'currency': 'EUR',
    'summary': """This app allow to re-assign or Escalate ticket to user and team and notify by emails.
    """,
    'author': 'Probuse Consulting Service Pvt. Ltd.',
    'website': 'http://www.probuse.com',
    'support': 'contact@probuse.com',
#    'live_test_url': 'https://youtu.be/_MvR7yoxx1Q',
    # 'live_test_url': 'https://youtu.be/D0XB1lyYwqQ',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/helpdesk_support_ticket_reassign/248',#'https://youtu.be/OteviPOCZYU',
    'description': """
This app allow to re-assign ticket to user or team and notify them.
    Allow to you to re-assign ticket to user or team.
...
""",
    'data': [
        ...
        # 'data/mail_template_reassign.xml',
        # 'data/mail_template.xml',
        'data/mail_template_new.xml',
        'wizard/helpdesk_support_reassign.xml',
