...
def import_QBD_Accounts_to_TPA():
    try:
        ...
        if to_execute_account == 1:
            ...
            # print (time_modified)
            parent_accounts = "SELECT TOP {} ListID, ParentRefListID, Name, AccountType, AccountNumber, TimeModified FROM account where ListID >={}".format(limit, request.args.get('last_qbd_id'))
