...
{
    'name': 'Helpdesk Analytic Cost and Revenue Analysis',
    'version' : '6.1.6',
    'currency': 'EUR',
    'license': 'Other proprietary',
    'price': 29.0,
    'summary': """This app allow helpdesk team to do make analysis of cost and revenue of tickets by analytic accounts.""",
    'description': """
...
#    'live_test_url': 'https://youtu.be/2-04c-hLgPk', odoo13
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/helpdesk_analytic_cost_revenue/730',#'https://youtu.be/aJUpte-qmVg',
