...
class Website(models.Model):
	...
	def wk_get_default_product(self):
		return self.env['ir.default'].sudo()._get('res.config.settings', 'wk_coupon_product_id')

	def voucher_value_get_type(self):
		return self.env['ir.default'].sudo()._get('res.config.settings', 'voucher_value_type')
	...
	@api.model
	def update_voucher_value(self, sale_order):
		order_total_price = 0
