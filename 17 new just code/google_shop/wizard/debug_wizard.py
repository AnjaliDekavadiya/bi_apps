    ...
    def dry_run(self):
        try:
            ...
            if product:
                ...
                fields = ['name', 'default_code', 'website_url', 'website_meta_description', 'lst_price']
                data = google_shop.get_mapped_set(product.sudo().read(fields), field_mapping_lines, base_url, 'insert')
