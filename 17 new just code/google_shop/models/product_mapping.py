        ...
        # if self._context.get('active_ids'):
            ...
            for shop in shop_ids:
                ...
                if token_result == 'error':
                    return shop.env['wk.wizard.message'].genrated_message("Attention, Captain! Your account needs a high-five from the authorization fairy before setting sail into the digital seas.\n Get ready to unlock the magic!", name='Authorization Request')
