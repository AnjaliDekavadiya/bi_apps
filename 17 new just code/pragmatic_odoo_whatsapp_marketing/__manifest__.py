{
    ...
    """,
    'depends': ['pragtech_whatsapp_base', 'mail'],
    'depends': ['pragtech_whatsapp_base', 'pragmatic_odoo_whatsapp_integration', 'mail'],
    'data': [
        ...
        'wizard/marketing_confirmation_template_wizard_view.xml',
    ],
    'qweb': [
    ],
    'images': ['static/description/whatsapp_message_marketing_gupshup_campaignsbanner.jpg'],
