...
#                 'service_type': int(service_id),
    ...
    def appointment_get(self, **post):
        ...
        slot_obj = http.request.env['appointment.slot.custom']
...
#                    'year': int(post['year']), odoo13
    ...
    def fleet_repair_submitted(self, **post):
        ...
        book_slots = event_obj.sudo().search([('partner_ids', 'in', [appointee_id]),
                                              ...
                                              ('start_date', '=', start_datetime_strf)])
        if appointee_id:
...
#         
    ...
    def _prepare_fleet_repair_vals(self, kw, repair=None):
        return {
            'repair': repair, 
            'fleet_repair': repair, 
    ...
    def my_repiar(self, repair=None, **kw):
        ...
        fleet_repair_vals = self._prepare_fleet_repair_vals(kw, repair=repair)
        return request.render("fleet_repair_request_management.display_fleet_repairs",fleet_repair_vals)
