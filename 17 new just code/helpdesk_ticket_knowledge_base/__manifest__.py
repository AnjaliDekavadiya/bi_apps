...
{
    'name': 'Knowledge Base for HelpDesk Support Ticket',
    'price': 72.0,
    'version': '6.7.1',
    ...
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/helpdesk_ticket_knowledge_base/606',#'https://youtu.be/hO7TetXlhE8',
    'images': [
        'static/description/img1.png'
    ],
    'summary': """This app allow you to create knowledge base for support tickets. Questions and Answers for Helpdesk.""",
    'description': """
Help Desk Ticket - Knowledge Base Question and Answer

* INHERIT Forum Assets (qweb)
* INHERIT Knowledge Base (qweb)
* INHERIT Knowledge Base (qweb)
* INHERIT helpdesk.support.form.inherit.history (form)
Knowledge Base (qweb)
Knowledge Base (qweb)
Knowledge Base Form (qweb)
Success Page (qweb)
helpdesk.post.question.wizard.form (form)
helpdesk.search.question.wizard.form (form)
view.ticket.faq.category.form (form)
view.ticket.faq.category.search (search)
view.ticket.faq.category.tree (tree)
view.ticket.faq.form (form)
view.ticket.faq.search (search)
view.ticket.faq.tags.form (form)
view.ticket.faq.tags.search (search)
view.ticket.faq.tags.tree (tree)
view.ticket.faq.tree (tree)
knowledge base
...
helpdesk Knowledge Base (Q&A)
Knowledge Base (Q&A) helpdesk
Knowledge Base helpdesk
Knowledge Base (Q&A)
question and answer
Knowledge Base database
quick Knowledge Base (Q&A)
forum
website forum
website Knowledge Base (Q&A)
website Knowledge Base
ticket Knowledge Base (Q&A)
blogs Knowledge Base (Q&A)
blogs
website blogs
...
""",
    'data':[
        ...
        'views/ticket_faq_view.xml',
        'views/ticket_faq_view_category.xml',
        'views/ticket_faq_view_tags.xml',
        'views/menu.xml',
        'wizard/search_question_wizard_view.xml',
        'wizard/post_question_wizard_view.xml',
        'views/helpdesk_ticket_view.xml',
        'views/website_template_view.xml'
    ],
    'assets': {
            'web.assets_frontend': [
                'helpdesk_ticket_knowledge_base/static/src/js/ticket_html_textarea.js',
                'helpdesk_ticket_knowledge_base/static/src/css/website_forum.css',
        ],
    },
