...
class security_role_rule_period(models.Model):
    ...
    rule_id = fields.Many2one("security.role.rule", string="Rule", required=True, ondelete="cascade")
    ...
    def _get_all_active_periods(self, role_id=None):
        ...
        is_inside_domain = [
            "|", ("period_start", "<=", datetime_now), ("period_start", "=", False),
            "|", ("period_end", ">=", datetime_now), ("period_end", "=", False),
        ]
        if role_id:
