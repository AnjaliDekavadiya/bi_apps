...
class NewDeliveryOrderWizard(models.TransientModel):
    ...
    officer_group=fields.Boolean(string="Officer Group",default=lambda self: self._get_group())

    @api.model
    def _get_group(self):
        _logger.info("..............[[[[[[[[[[[")
        return self.env.user.has_group('odoo_marketplace.marketplace_officer_group')
