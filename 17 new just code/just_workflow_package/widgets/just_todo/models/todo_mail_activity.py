...
class ActivityTodo(models.Model):
    ...
    todo_state = fields.Selection([('todo', 'todo'), ('complete', 'complete')],  default='todo')
    ...
    def compute_coordination_source(self, res_modelId, resId):
        res_model_id = self.env['ir.model'].browse(res_modelId)
    ...
    def done(self, record_id=False):
        ...
        '''
        self.ensure_one()
        self.with_context({}).write({'todo_state': 'complete'})
