        ...
        this.humanConfig = {
            ...
            face: {
                ...
                detector: {
                    ...
                    iouThreshold: 0.01,
                    minConfidence: 0.6,
                    modelPath: '/lunch_kiosk_mode_adv/static/src/lib/models/blazeface.json',
                },
                mesh: { 
                    enabled: true,
                    modelPath: '/lunch_kiosk_mode_adv/static/src/lib/models/facemesh.json',
                },
                iris: { 
                    enabled: false,
                    modelPath: '/lunch_kiosk_mode_adv/static/src/lib/models/iris.json',
                },
                emotion: { 
                    enabled: false,
                    modelPath: '/lunch_kiosk_mode_adv/static/src/lib/models/emotion.json',
                },
                description: { 
                    enabled: true,
                    modelPath: '/lunch_kiosk_mode_adv/static/src/lib/models/faceres.json',
                },
            },
            body: { enabled: false },
            hand: { enabled: false },
