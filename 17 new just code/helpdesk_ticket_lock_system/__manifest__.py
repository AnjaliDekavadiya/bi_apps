...
{
    'name': 'Helpdesk Support Ticket Locking System',
    'currency': 'EUR',
    'price': 10.0,
    'depends': [
    ...
    'summary': """This module all ticket user to lock helpdesk ticket.""",
    'description': """
Helpdesk ticket lock system
Allowed user to lock ticket for particular days ot hours
Allowed user to update locked data who are locked it.
Not allowed to update other users
Creating Helpdesk Support ticket
Lock ticket
Locked Support Ticket
Lock Helpdesk Support Ticket
...
issue operator
    ...
    # 'live_test_url': 'https://youtu.be/DYey0QsERLE',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/helpdesk_ticket_lock_system/609',#'https://youtu.be/T2W0T1iO0fY',
    'data':[
        'security/ir.model.access.csv',
        'wizard/lock_support_ticket_view.xml',
