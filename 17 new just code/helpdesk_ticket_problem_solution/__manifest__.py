...
{
    'name': 'Solution Answer for Helpdesk Support Ticket and Issue',
    'version': '4.7.1',
...
#    'live_test_url' : 'https://youtu.be/sa6YncX9-0Q',
    'live_test_url' : 'https://probuseappdemo.com/probuse_apps/helpdesk_ticket_problem_solution/611',#'https://youtu.be/PBpsHzO29nk',
    'currency': 'EUR',
    'category': 'Services/Project',
    'summary': """This app allow you make solution on ticket/issue of helpdesk and send to customer and Portal View of Solution.""",
    'description': """
ticket solution
helpdesk solution
ticket answer
support solution
problem solution
Helpdesk Ticket Problem Solution
Provide solution for ticket 
Solution on report
Solution on frn end of ticket
...
issue operator​
    ...
    'data':[
        ...
        'views/helpdesk_support_report_template.xml',
        'views/my_ticket_template.xml'
    ],
    'installable' : True,
    'application' : False,
}
