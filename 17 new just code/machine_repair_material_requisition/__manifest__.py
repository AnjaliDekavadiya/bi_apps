...
{
    'name': 'Machine Repair Integration with Material Requisition',
    'version': '8.3.3',
    ...
    'summary': """This module provide integration between machine repair module and material requisition module.""",
    'description': """
Odoo Machine Repair Material Requisition
...
Machine Repair Material Requisition
Material Requisition Tab on Machine Repair
Requisition on Machine Repair
Machine Repair on Material Requisition  
""",
    'author': "Probuse Consulting Service Pvt. Ltd.",
    'website': "www.probuse.com",
    'support': 'contact@probuse.com',
    # 'live_test_url': 'https://youtu.be/aUoRbtAmJ0g',
    #'live_test_url':'https://youtu.be/f_mgbMoxB6A',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/machine_repair_material_requisition/453',#'https://youtu.be/65ni4cWI47c',
