...
class DeliveryCarrier(models.Model):
    ...
    delivery_type = fields.Selection(selection_add = [('hyperlocal_shipping','Hyperlocal Shipping')],ondelete={'hyperlocal_shipping': 'cascade'})
    ...
    def getShippingRate(self, order, actualDistance):
        ...
        # if self.delivery_type=='hyperlocal_shipping':
        #     carrierRate = self.hyperlocal_default_price
