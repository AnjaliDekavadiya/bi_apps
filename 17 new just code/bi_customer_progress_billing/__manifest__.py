...
{
    'name': 'Customer Progress Billing-Invoice in Odoo',
    'version': '17.0.0.0',
    'category': 'Accounting',
    'author': 'BrowseInfo',
    'website': 'https://www.browseinfo.com',
    'summary': 'App Project Job Costing billing construction billing project construction Progress Billing send invoice progress billing customer billing for project progress billing in construction Progress Billing to Customer Progress Billing construction',
    'description': """
    Odoo Project Job Costing and Job Cost Sheet billing accounting billing report billables contract bill progress bill 
    Odoo customer billing for project progress billing in construction Progress Billing to Customer Progress Billing construction 
    Odoo construction Progress Billing send invoce progress billing
	Odoo project progress billing progress done invoice automated invoice progress billing construction billing construction project billing in Odoo
    Odoo send progress billing to customer progress billing for customer
    odoo partner progress billing customer invoice progress customer previous invoiced amount
    odoo customer remaining billing amount on customer remaining amount to pay customer
    odoo customer customer due amount customer total due amount customer overdue amount
    customer amount to pay partner amount to pay billing amount to pay customer previous paid amount
...
aistikhdam wahdat limutabaeat alfatwrt , mutabaeat alhisab , mutabaeat aldafe , mutabaeat aleumala' lilfaturat , 'iirsal risalat lilfaturat , 'iirsal albarid al'iiliktrunii lilmutabaeata. 'iirsal albarid al'iiliktrunii lidafe outstading ، 'iirsal albarid al'iiliktrunii lildafe almuta'akhirati. 'iidarat mutabaeat alhisab , 'iidarat mutabaeat aleumla' , mutabaeat aldafe alhisab , mutabaeat aleumala' alhisab , 'iidarat aldafe almutabaeat , 'iidarat hisab almutabaeat , mutabaeat aleumla' Outstading , almutabaeat almutamayizat , wamutabaeat aldafe almuealaq
    ...
    Odoo Job Cost Sheet job contract job contracting Construction job contracting job contract estimation cost estimation project estimation 
        This modules helps to manage contracting,Job Costing and Job Cost Sheet inculding dynamic material request
""",
    'depends': [
        'base', 'sale_management', 'mail', 'sales_team', 'analytic', 'account', 'project',
    ],
    'data': [
        'views/account_analytic.xml',
        'views/account_invoice_view.xml',
        'report/report_progress_billing.xml',
        'report/report_progress_view.xml',
    ],
    "price": 29,
    "currency": "EUR",
    'installable': True,
    'auto_install': False,
    'live_test_url': 'https://youtu.be/L0sr5zSzwBA',
