...
class Office365MailChannel(models.Model):
    ...
    ks_office365_channel_inbox = fields.Many2one('discuss.channel',
                                                 string="Office365 Inbox")
    ks_office365_channel_sentitems = fields.Many2one('discuss.channel',
                                                     string="Office365 Sentitems")
    ks_office365_channel_archive = fields.Many2one('discuss.channel',
        ...
        for folder in ks_initial_folder:
            ...
            if not ks_is_exist:
                ...
                if ks_channel_res:
                    ...
                    # @INFO: No need of this code for version odoo 15
