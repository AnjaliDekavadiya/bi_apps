...
{
    'name': 'Employees Availability for Helpdesk Tickets',
    'price': 19.0,
    'category': 'Services/Project',
    'version': '5.1.5',
    'currency': 'EUR',
    'license': 'Other proprietary',
    'summary': """Employees Availability for Helpdesk Tickets""",
    'description': """
Helpdesk Employees Availability
...
""",
    ...
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/helpdesk_employees_availability/739',#'https://youtu.be/NIyDOSzxg1s',
    'images': ['static/description/images.png'],
    'depends': ['website_helpdesk_support_ticket'],
    'installable' : True,
    'application' : False,
    'data': [
        'views/helpdesk_dashbord_view.xml',
    ],
}
