...
class Procurement(models.TransientModel):
    ...
    project_id = Many2one('project.project', 'Project Name', required=False,domain=[('approval_state','=','approve')])
    ...
    material = fields.Selection([('All Material', 'All Material'), ('Show All Material from project', 'Show All Material from project'), ('Single Material', 'single Material')])
    material_selection = fields.Selection([('all', 'All Material'), ('from_single_project', 'Show All Material from project'), ('single', 'single Material')], default='from_single_project')
    ...
    def save_method(self):
        ...
        for procure_lines in self.procurement_line_ids:
            if procure_lines.is_select == True:
                ...
                resulted_req_lines = self.env['purchase.requisition'].search([('name', '=', procure_lines.requisition_no)])
