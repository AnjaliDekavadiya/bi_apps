...
class PurchaseRequisition(models.Model):
    ...
    purchase_ids = fields.Many2many('purchase.order', 'po_requisition_rel1', 'requisition_id', 'purchase_id', string='Purchase Orders')
    ...
    task_category = fields.Many2many('task.category', 'purchase_req_task_cat_rel', 'purchase_req_id', 'task_category_id', string='Task Category')
