...
class ResPartner(models.Model):
    ...
    vendor_status = fields.Selection([('trial', 'Trial'), ('approved', 'Approved'), ('suspended', 'Suspended'), ('black_listed', 'Black Listed')], 'Vendor Status', default='trial')
    ...
    def write(self, vals):
        ...
        if vals.get('vendor_status'):
            ...
            remark_string = 'Status changed by ' + (self.env['res.users'].browse(self._context.get('uid'))).name + ' to ' + status
