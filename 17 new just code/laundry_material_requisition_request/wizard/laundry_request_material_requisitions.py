...
class LaundryRequestMaterialRequisition(models.TransientModel):
    _name = 'laundry.custom.material.requisition.wizard'
    _description = 'Laundry Request Material Requisition Wizard'
    ...
    def default_get(self, fields):
        res = super(LaundryRequestMaterialRequisition, self).default_get(fields)
    ...
    def create_custom_material_requisition(self):
        ...
        action['context'] = {
            ...
            'default_custom_laundry_request_id' : active_id.id,
        }
        return action
