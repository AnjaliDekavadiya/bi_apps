...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update({
            ...
            'notify_reminder_mail_template':IrDefault._get('res.config.settings', 'notify_reminder_mail_template')
                or appoint_reminder_mail_template,
            'enable_notify_customer_on_approve_appoint':IrDefault._get('res.config.settings', 'enable_notify_customer_on_approve_appoint'),
            'notify_customer_on_approve_appoint':IrDefault._get('res.config.settings', 'notify_customer_on_approve_appoint')
            ...
            'notify_customer_on_reject_appoint':IrDefault._get('res.config.settings', 'notify_customer_on_reject_appoint')
            ...
            'notify_customer_on_new_appoint':IrDefault._get('res.config.settings', 'notify_customer_on_new_appoint')
            ...
            'notify_admin_on_new_appoint':IrDefault._get('res.config.settings', 'notify_admin_on_new_appoint')
