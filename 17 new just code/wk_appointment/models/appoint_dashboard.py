...
class AppointmentDashboard(models.Model):
    ...
    def is_user_apointee(self):
        ...
        appointee_group = self.env['ir.model.data']._xmlid_lookup(
            'wk_appointment.appointment_appointee_group')[1]
        officer_group = self.env['ir.model.data']._xmlid_lookup(
            'wk_appointment.appointment_officer_group')[1]
        manager_group = self.env['ir.model.data']._xmlid_lookup(
            'wk_appointment.appointment_manager_group')[1]
    ...
    def _get_new_appoint_count(self):
        ...
        for rec in self:
            if rec.is_user_apointee():
                ...
                obj = self.env['appointment'].search(['|',('company_id','=',company_id),('company_id', '=', False),('appoint_state', '=', 'new')])
    ...
    def _get_pending_appoint_count(self):
        ...
        for rec in self:
            if rec.is_user_apointee():
                ...
                obj = self.env['appointment'].search(['|',('company_id','=',company_id),('company_id', '=', False),('appoint_state', '=', 'pending')])
    ...
    def _get_approved_appoint_count(self):
        ...
        for rec in self:
            if rec.is_user_apointee():
                ...
                obj = self.env['appointment'].search(['|',('company_id','=',company_id),('company_id', '=', False),('appoint_state', '=', 'approved')])
    ...
    def _get_rejected_appoint_count(self):
        ...
        for rec in self:
            if rec.is_user_apointee():
                ...
                obj = self.env['appointment'].search(['|',('company_id','=',company_id),('company_id', '=', False),('appoint_state', '=', 'rejected')])
    ...
    def _get_done_appoint_count(self):
        ...
        for rec in self:
            if rec.is_user_apointee():
                ...
                obj = self.env['appointment'].search(['|',('company_id','=',company_id),('company_id', '=', False),('appoint_state', '=', 'done')])
