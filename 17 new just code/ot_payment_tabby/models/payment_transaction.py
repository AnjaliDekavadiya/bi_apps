    ...
    def _get_checkout_tabby_details(self):
        ...
        data = {
              "payment": {
                ...
                "currency":'SAR' if self.provider_id.state == 'test' else self.currency_id.name,
                ...
                "buyer_history": {
                  ...
                  "loyalty_level": int(sum(self.env['sale.order'].sudo().search([('partner_id','=',self.partner_id.id),('state','=','sale')]))),#
