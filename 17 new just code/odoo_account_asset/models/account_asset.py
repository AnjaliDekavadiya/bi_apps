...
class AccountAssetAsset(models.Model):
    ...
    note = fields.Text()
    category_id = fields.Many2one('account.asset.category.custom', string='Category', required=True, change_default=True, 
        # readonly=True, 
        # states={'draft': [('readonly', False)]}
    )
    ...
    method = fields.Selection([('linear', 'Linear'), ('degressive', 'Degressive')], string='Computation Method', required=True, 
        readonly=True, 
        # states={'draft': [('readonly', False)]}, 
        default='linear',
        help="Choose the method to use to compute the amount of depreciation lines.\n  * Linear: Calculated on basis of: Gross Value / Number of Depreciations\n"
    ...
    method_time = fields.Selection([('number', 'Number of Entries'), ('end', 'Ending Date')], string='Time Method', required=True, readonly=True, default='number', 
        # states={'draft': [('readonly', False)]},
        help="Choose the method to use to compute the dates and number of entries.\n"
             "  * Number of Entries: Fix the number of entries and the time between 2 depreciations.\n"
             "  * Ending Date: Choose the time between 2 depreciations and the date the depreciations won't go beyond."
    ...
    depreciation_line_ids = fields.One2many('account.asset.depreciation.line.custom', 'asset_id', string='Depreciation Lines', readonly=True, 
