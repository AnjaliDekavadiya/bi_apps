...
{
    'name': "Dashboard for Helpdesk Support Tickets",
    ...
    #'live_test_url': 'https://youtu.be/sk7xwd5WL0k',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/helpdesk_support_ticket_dashbord/588',#'https://youtu.be/VIlPHPc9WUE',
    'category' : 'Services/Projects',
    'license': 'Other proprietary',
    'price': 79.0,
    'currency': 'EUR',
    'summary': """Dashboard for Helpdesk Ticket / Issue / Claim Management""",
    'description': """
Added new dashboard for helpdesk tickets.
helpdesk dashboard
ticket dashboard
dashboard
support dashboard
...
- This Week
    - State: New
    - Date: Between current week start date and end date
- This Month
    - State: New
    - Date: Between current month start date and end date
- Last Month
    - State: New
    - Date: Between previous month start date and end date
...
- This Week
    - State: not closed
    - Deadline Date: Between current week start date and end date
- This Month
    - State: not closed
    - Deadline Date: Between current month start date and end date
- Last Month
    - State: not closed
    - Deadline Date: Between previous month start date and end date
...
""",
    'data':[
        ...
        'views/support_team_dashboard_view.xml',
        'views/helpdesk_support_view.xml',
    ],
    'assets': {
        
        'web.assets_backend': [
            # 'helpdesk_support_ticket_dashbord/static/src/scss/helpdesk.scss',
            'helpdesk_support_ticket_dashbord/static/src/scss/helpdesk_new.scss',
        ],
    },
    'installable' : True,
    'application' : False,
