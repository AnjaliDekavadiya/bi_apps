...
class Message(models.Model):
    ...
    def message_format(self, format_reply=True, msg_vals=None):
        res = super(Message, self).message_format(format_reply=format_reply, msg_vals=msg_vals)
        partners_dict = {}
        for obj in res:
            cc_partners = ''
            bcc_partners = ''
...
class Mail(models.Model):
    ...
    def _prepare_outgoing_list(self, recipients_follower_status=None):
        results = super(Mail, self)._prepare_outgoing_list(recipients_follower_status)
...
class Thread(models.AbstractModel):
    ...
    def _notify_thread_by_email(self, message, recipients_data, msg_vals=False,
        ...
        :param bool check_existing: check for existing notifications to update
