...
class AccountBankStatementLine(models.Model):
    ...
    company_branch_id = fields.Many2one(
        ...
        string="Branch",
        copy=False,
        related='statement_id.company_branch_id'
        # default=lambda self: self.env.user.company_branch_id.id,
    )

    #this method is not available in v.14.
    def process_reconciliation_dummy(self, counterpart_aml_dicts=None, payment_aml_rec=None, new_aml_dicts=None):
