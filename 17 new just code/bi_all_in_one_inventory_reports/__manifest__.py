...
Generate Excel Report for All Warehouses Stock and Particular Warehouses Stock Between Specific Dates.
    ...
    'depends': [
            'bi_inventory_valuation_reports','bi_stock_expiry_report',
            'bi_non_moving_product','bi_inventory_coverage_report',
            'bi_inventory_report','bi_stock_rotation_report',
            'export_stock_info','bi_inventory_overstock_report'
        ],
    'data': [
    ],
    'live_test_url':'https://youtu.be/IFgJnk8VEiA',
    'qweb':[
    ],
    'license':'OPL-1',
    "auto_install": False,
