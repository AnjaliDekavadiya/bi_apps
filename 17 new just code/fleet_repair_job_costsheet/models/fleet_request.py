...
class FleetRequest(models.Model):
    ...
    def _prepare_jobcost_vals(self, job_type):
        if  job_type == 'material':
            ...
            cost_line_lst = []
            for material in self.material_jobcost_line_ids:
                ...
                jobcost_line_values['product_qty'] = material.product_qty
    ...
    def show_jobcost_sheet(self):
        ...
        action['domain'] = [('fleet_request_id', '=', self.id)]
        return action
